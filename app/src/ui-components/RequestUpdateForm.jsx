...
export default function RequestUpdateForm(props) {
  const {
    id: idProp,
    request: requestModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    ...
    setSeniorID(cleanValues.seniorID);
    setVolunteerID(cleanValues.volunteerID);
    setStatus(cleanValues.status);
    setCountry(cleanValues.country);
    setLocale(cleanValues.locale);
    setSeniorFeedback(cleanValues.seniorFeedback);
    setVolunteerFeedback(cleanValues.volunteerFeedback);
    ...
    setVolunteerName(cleanValues.volunteerName);
  ...
  React.useEffect(() => {
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getRequest.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getRequest
        : requestModelProp;
    ...
    queryData();
  }, [idProp, requestModelProp]);
  React.useEffect(resetStateValues, [requestRecord]);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateRequest.replaceAll("__typename", ""),
            variables: {
              input: {
                id: requestRecord.id,
                ...modelFields,
      ...
      {...getOverrideProps(overrides, "RequestUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || requestModelProp)}
